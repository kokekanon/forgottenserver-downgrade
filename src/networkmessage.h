...
public:
	...
	void addItem(uint16_t id, uint8_t count, const bool isOTC, const bool isMehah, const bool isOTCv8);
	void addItem(const Item* item, const bool isOTC, const bool isMehah, const bool isOTCv8);
